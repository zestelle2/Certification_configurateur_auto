 ...
 */
final class Version20190611120243 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE auto (id INT AUTO_INCREMENT NOT NULL, version_name VARCHAR(255) NOT NULL, version_price DOUBLE PRECISION NOT NULL, color_name VARCHAR(255) NOT NULL, color_price DOUBLE PRECISION NOT NULL, rims_name VARCHAR(255) NOT NULL, rims_price DOUBLE PRECISION NOT NULL, seat_name VARCHAR(255) NOT NULL, seat_price DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, date_of_birth DATE NOT NULL, avatard VARCHAR(255) DEFAULT NULL, adress VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, current_location VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
