 ...
 */
final class Version20190611220239 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD password_confirm VARCHAR(255) NOT NULL, DROP date_of_birth');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD date_of_birth DATE NOT NULL, DROP password_confirm');
    }
}
